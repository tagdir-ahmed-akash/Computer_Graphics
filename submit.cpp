...
#define UPPER_LEG_RATE	5			/* motion rate for variable "left_hip" and "right_hip" */
#define LOW_LEG_RATE	5			/* motion rate for variable "left_knee" and "right_knee" */
...
GLfloat mat_specular1[] = { 0.8, 0.8, 0.0, 1.0 };
GLfloat mat_ambient1[] = { 0.0, 0.0, 0.0, 1.0 };
GLfloat mat_diffuse1[] = { 0.0, 0.6, 0.0, 1.0 };
GLfloat mat_shininess1[] = { 128.0 * 0.4 };

// Updated material properties for forearm
...
GLfloat mat_ambient7[] = { 0.0, 0.0, 0.0 };
GLfloat mat_diffuse7[] = { 0.5, 0.5, 0.0 };
GLfloat mat_shininess7[] = { 128.0 * 0.25 };

GLfloat mat_specular8[] = { 0.508273, 0.508273, 0.508373 };
GLfloat mat_ambient8[] = { 0.19225, 0.19225, 0.19225 };
GLfloat mat_diffuse8[] = { 0.50754, 0.50754, 0.50754 };
GLfloat mat_shininess8[] = { 128.0 * 0.6 };

unsigned int texture;
unsigned int texture_moon;
unsigned int texture_saturn;
unsigned int texture_Mars;
...
void DrawTorso(void)
{
	...
	glBindTexture(GL_TEXTURE_2D, texture_moon);  // Assuming 'texture' is the Earth texture ID
...
void DrawHip(void)
{
	...
	glPushMatrix();
	glScaled(4, 1, 1.5); // Adjust scaling to make it more proportional
...
void DrawShoulder(void)
{
	...
	SetMaterial(mat_specular2, mat_ambient2, mat_diffuse2, mat_shininess2);
	glPushMatrix();
	glScalef(5, 1, 1.5); // Adjust scaling to make it bigger
...
void DrawUpperArm(void)
{
	...
	glPushMatrix();
	glScalef(1.0, 3.0, 1.0); // Adjust scaling to make it longer
	glutSolidSphere(0.45, 20, 20);  // Increase the length of the upper arm
	glPopMatrix();
...
void DrawForeArm(void)
{
	...
	glPushMatrix();
	glScalef(1.2, 2.0, 1.2); // Adjust scaling to make it shorter and thicker
	glutSolidSphere(0.25, 20, 20);
	glPopMatrix();

	// Add a cube under the forearm
	glPushMatrix();
	glTranslatef(0.0, -0.75, 0.0); // Adjust the position of the sphere
	glutSolidSphere(0.25, 20, 20); // Adjust the size of the sphere
	glPopMatrix();
...
void DrawUpperLeg(void)
{
	...
	glPushMatrix();
	glScalef(1.5, 3.0, 1.0); // Adjust scaling to make it thicker
...
void DrawLowerLeg(void)
{
	...
	SetMaterial(mat_specular2, mat_ambient2, mat_diffuse2, mat_shininess2);
	glPushMatrix();
	glScalef(1.0, 2.0, 1.0); // Adjust scaling to make it thinner
	glutSolidSphere(0.4, 20, 20);
	glPopMatrix();
...
void DrawFoot(void)
{
	...
	glPushMatrix();
	glScalef(1.0, 0.5, 1.0); // Adjust scaling to make it smaller
	glutSolidSphere(0.4, 20, 20);
	glPopMatrix();
...
void DrawHead(void)
{
	...
	glEnable(GL_TEXTURE_2D);
	glBindTexture(GL_TEXTURE_2D, texture);  // Assuming 'texture_saturn' is the Saturn texture ID
	...
	glutSolidSphere(0.08, 10, 10);  // Adjust the size as needed
	glPopMatrix();
